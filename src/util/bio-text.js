let text = [];
text[0] = `Darío Andrade Mendoza is a DACA Recipient, holds a Master’s Degree in Electrical and Computer Engineering, is a Software Developer, the Communications and Development lead at ScholarshipsA-Z and has been a part of our Tucson community since 2003.`;
text[1] =
...
text[7] =
  "He has served as a volunteer Executive Team member at ScholarshipsA-Z for 5 years. From advocating for policy changes to directing the Immigrant Scholarship Hustle program, to developing the leadership and funding for the organization. He has been an astounding grassroots organizer and leader in Tucson.";
